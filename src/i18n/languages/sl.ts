...
export const slovenian = {
  ...
  checkout: {
    ...
    postalCodeAriaLabel: 'Vnesite 4-mestno poštno številko',
    cityAriaLabel: 'Vnesite ime mesta',
    postalCodeNotFound: 'Poštna številka ni v bazi - vnesite mesto ročno',
    autoFilled: 'Samodejno',
    ...
    upnQrTitle: 'Plačilo z UPN QR kodo',
    upnQrInstructions: 'Skenirajte QR kodo z vašo mobilno bančno aplikacijo za hitro plačilo.',
    downloadQR: 'Prenesi QR kodo',
    copyIBAN: 'Kopiraj IBAN',
    recipient: 'Prejemnik',
    purpose: 'Namen',
    dueDate: 'Rok plačila',
    upnQrNote: 'Opomba: Po plačilu boste prejeli potrditev na e-pošto. Naročilo bo odposlano po prejemu plačila.',
